...
wdir = 'weights_qr2' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
#     batch_size = opt.batch_size
    ...
    # for f in glob.glob(wdir + '*_batch*.jpg') + glob.glob(results_file):
    #    os.remove(f)
...
#             if ni == 0:
            if ni % nb == 0:
                fname = 'trainepoch'+str(epoch)+'_batch0.jpg'
                fname = wdir + fname
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/coco_qr.data', help='*.data file path')
